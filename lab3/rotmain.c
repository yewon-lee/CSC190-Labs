...
int main(void){	
	...
	printf("INFO: printing lvl order after rotation\n");
	XprintLevelOrder(root);
	printf("INFO: printing increasing order after rotation\n");
	printTreeInOrder(root);
	printf("INFO: printing the BF's after rotation\n");
	printBFeverywhere(root);
	return 0;
}
